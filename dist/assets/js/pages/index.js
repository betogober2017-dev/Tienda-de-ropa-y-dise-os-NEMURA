/* ============================================================
    ...
    async function cargarProductosDesdeExcel() {
      ...
      try {
        ...
        state.productos = data.filter(p => p.activo !== 'False');
    ...
    function renderProductos(lista) {
      ...
      if (!lista || lista.length === 0) {
        grid.innerHTML =
          `<div style="grid-column:1/-1;text-align:center;padding:60px 20px;color:#888;"><h3>No hay productos disponibles</h3><p style="opacity:0.3;">Pronto tendremos más productos</p></div>`;
        return;
      }
      ...
      grid.innerHTML = lista.map((p, i) => {
        ...
        if (tipo === 'digital') { badgeClass = 'digital';
          badgeText = '💻 Digital'; } else if (tipo === 'vaso') { badgeClass = 'vaso';
          badgeText = '🧋 Vaso'; }
    ...
    NemuraCarousel.mount('#carruselNuevos', {
      ...
      tipo: null, // todos los tipos, mezclados
      limite: 12,
      onOpen: abrirModal,
